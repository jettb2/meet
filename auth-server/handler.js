...
const credentials = {
  ...
  redirect_uris: ["https://jettb2.github.io/meet/"],
  javascript_origins: ["https://jettb2.github.io", "http://localhost:3000"],
};
...
module.exports.getCalendarEvents = async (event) => {
  ...
  const access_token = decodeURIComponent(`${event.pathParameters.acess_token}`);
